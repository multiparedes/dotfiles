  ...
  { -- Collection of various small independent plugins/modules
    ...
    config = function()
      ...
      starter.setup {
        header = start_header,
        items = {
          starter.sections.recent_files(8, true, false), -- recent files in cwd, names only
        },
        footer = '',
        content_hooks = {
...
end, {nowait = true, noremap = true, silent = true, desc = "Neotree toggle"})
...
vim.keymap.set('n', '<C-I>', ':BufferPrevious<CR>', {noremap = true})
